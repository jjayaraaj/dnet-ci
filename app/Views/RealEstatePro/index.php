...
<?= $this->section("title") ?> RealEstatePro <?= $this->endSection("title") ?>
    ...
    <div class="max-w-container mx-auto h-full big-screen">
        ...
        <div class="  w-full  h-[500px]">
            ...
            <div class=" mx-auto max-w-container big-screen  h-full flex items-center ">
                <div class=" space-y-8">
                    <div class="text-[2rem] font-bold max-w-3xl flex-1 leading-tight">
...
<div class=" max-w-container py-16 space-y-4">
    <div class="  mx-auto text-center ">
        <div class=" heading-1 w-3/4 mx-auto">Resolve challenges in real estate operations with Microsoft Dynamics 365 Property management solution!</div>
    </div>
    ...
    <div class=" max-w-container space-y-8">
        ...
        <div class="flex">
            ...
            <div class=" flex-1 space-y-8">
                ...
                <div class="bg-primary p-6 space-y-8">
    ...
    <div class=" max-w-container space-y-8 py-16">
        <div class="flex">
            <div class=" w-2/5 space-y-8">
                <div>
                    <div class=" text-xl font-semibold">Transform your operations with our
                    </div>

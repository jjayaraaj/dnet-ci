...
<style>
    ...
    .bg-realestatepro-uae {
        background-image: linear-gradient(rgba(244, 249, 253, 0.1), rgba(244, 249, 253, 0.1)), url('<?php echo $realestateproBannerUae ?>');
    }
    ...
    .bg-support-banner {
        background-image: url('<?php echo $supportBanner ?>');
    }

    .bg-support-partner {
        background-image: url('<?php echo $supportPartnerBg ?>');
    }

    .bg-upgrade-banner {
        background-image: url('<?php echo $upgradeBanner ?>');
    }

    .bg-upgrade-partner {
        background-image: url('<?php echo $upgradePartnerBg ?>');
    }
